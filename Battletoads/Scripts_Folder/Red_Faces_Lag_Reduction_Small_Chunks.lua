...
-- 2500 trials are run using this process, and whenever an attempt generates a new lowest number of lag frames, the button presses that occured on the attempt are written to a file named "resultsOfBestScriptFile.txt"
